...
pres.title = 'Module 8 — Outils numériques et intelligence artificielle appliqués à la communication';
...
pres.writeFile({ fileName: 'Module-8-Colossyan.pptx' }).then(f => console.log('wrote', f));
